"""
This file contains code copied over from https://github.com/stanford-crfm/levanter
The original LICENSE is provided
"""
...
def flatten_linear_layers(prefix, layer: hnn.Linear, out_dims_first_in_dict: bool) -> StateDict:
...
def unflatten_linear_layers(prefix, statedict: StateDict, layer: hnn.Linear, out_dims_first_in_dict: bool) -> StateDict:
    # the model might have been stacked/blocked so we need to allow for an extra dimension
    # TODO: might be nicer to use vmap here
    # ensure it's numpy
