...
def flash_attention(
    ...
    *,
    ...
    return _flash_attention(
        (q, k, v), QPos, KPos, Key, dropout, inference=inference, key=key, block_size=block_size
    )
...
def _flash_attention(
    ...
    *,
    ...
    return _flash_attention_forward(
        None, qkv, QPos, KPos, Key, dropout, inference=inference, key=key, block_size=block_size
    )[0]
